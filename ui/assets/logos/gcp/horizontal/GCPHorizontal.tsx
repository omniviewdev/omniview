...
const SvgComponent: React.FC<Props> = ({ color, ...props }) => {
  ...
  return (
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 181 28' {...props}>
      <defs>
        <style>{`.cls-5{fill:${theme.palette.text.primary}}`}</style>
      </defs>
      <path
        ...
        style={{
          fill: color ? '#ea4335' : theme.palette.text.primary,
        }}
      />
      <path
