...
const file_proto_networker_proto_rawDesc = "" +
	"\n" +
	"\x15proto/networker.proto\x12\x16com.omniview.pluginsdk\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x14proto/resource.proto\"\xfc\x06\n" +
	"\x12PortForwardSession\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1f\n" +
	"\vsource_port\x18\x02 \x01(\x05R\n" +
	"sourcePort\x12)\n" +
	"\x10destination_port\x18\x03 \x01(\x05R\x0fdestinationPort\x12G\n" +
	...
	"\x03key\x18\x03 \x01(\tR\x03key\"\x86\x06\n" +
	"\x19PortForwardSessionOptions\x12\x1f\n" +
	"\vsource_port\x18\x01 \x01(\x05R\n" +
	"sourcePort\x12)\n" +
	"\x10destination_port\x18\x02 \x01(\x05R\x0fdestinationPort\x12G\n" +
