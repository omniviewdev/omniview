...
type Bus<E> = Record<keyof E, Array<E[keyof E]>>;
...
/**
 * Simple event bus implementation. If we need to add more complex logic for signaling
 * between components, we can use a more complex library like RxJS.
 * 
 * For now, this meets our use case of simple event handling.
 */
