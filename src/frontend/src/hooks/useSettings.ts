 ...
 */
export const useSettingsNamespace = (namespace: string) => {
 ...
 */
export const useSettingsNamespaceSection = (namespace: string, section: string) => {
  return useSelector((state: RootState) =>
    createSelector(
      [selectSettings],
      settings => {
...
*/
export const useSectionSettings = (namespace: string, section: string) => {
  return useSelector((state: RootState) =>
    createSelector(
      [selectSettings],
 ...
 */
export const useSetting = (identifier: string) => {
  return useSelector((state: RootState) =>
    createSelector(
      [selectSettings],
      settings => {
...
*/
export const useSettings = (identifiers: string[]) => {
  return useSelector((state: RootState) =>
    createSelector(
      [selectSettings],
      settings => {
