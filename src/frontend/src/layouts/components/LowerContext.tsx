...
* This area houses primarily the terminal
*/
const LowerContext: FC<LowerContextProps> = ({ clusterId }) => {
  const [height, _setHeight] = useState<number>(400);
  const [tabBarHeight, _setTabBarHeight] = useState<number>(42);
