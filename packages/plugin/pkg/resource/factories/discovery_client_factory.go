...
type ResourceDiscoveryClientFactory[T any] interface {
	...
	CreateClient(ctx context.Context, opts interface{}) (*T, error)
	...
	RefreshClient(ctx context.Context, client *T, opts interface{}) error
	...
	StartClient(ctx context.Context, client *T) error
	...
	// idempotent.
	StopClient(ctx context.Context, client *T) error
}
