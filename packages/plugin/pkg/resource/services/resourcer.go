...
type Resourcer[C, T any] interface {
	// Get returns a single resource in the given resource namespace.
	Get(ctx context.Context, client *C, id string) (*T, error)

	// List returns a list of resources in the given resource namespace.
	List(ctx context.Context, client *C, options interface{}) ([]*T, error)
	...
	Find(ctx context.Context, client *C, options interface{}) ([]*T, error)

	// Create creates a new resource in the given resource namespace.
	Create(ctx context.Context, client *C, input interface{}, options interface{}) (*T, error)

	// Update updates an existing resource in the given resource namespace.
	Update(ctx context.Context, client *C, id string, input interface{}, options interface{}) (*T, error)

	// Delete deletes an existing resource in the given resource namespace.
	Delete(ctx context.Context, client *C, id string, options interface{}) error
}
