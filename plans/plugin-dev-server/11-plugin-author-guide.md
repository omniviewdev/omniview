...
```bash
# Option 1: Use the CLI tool to scaffold
omniview-plugin-dev init --id my-plugin --dir ./plugins/my-plugin
...
# Via Homebrew
brew install omniviewdev/tap/omniview-plugin-dev

# Via npm
npm install -g @omniviewdev/plugin-dev
```
